...
We welcome all contributions to SVMem!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/msinclair-py/mda-svmem/issues)
...
The second two options both involve making a [pull request](https://github.com/msinclair-py/mda-svmem/pulls) .
