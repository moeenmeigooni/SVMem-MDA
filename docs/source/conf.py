...
htmlhelp_basename = "mda-svmemdoc"
...
latex_documents = [
    (master_doc, "mda-svmem.tex", "SVMem Documentation",
     "mda-svmem", "manual"),
]
...
man_pages = [
    (master_doc, "mda-svmem", "SVMem Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "mda-svmem", "SVMem Documentation",
     author, "mda-svmem", "A support vector machine approach to measuring Gaussian and mean membrane curvature, including in exotic systems including vesicular and tubular membranes.",
     "Miscellaneous"),
]
